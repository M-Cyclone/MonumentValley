...
#include "MvGamePhaseAbility.generated.h"

/**
 *
 */
UCLASS()
class MONUMENTVALLEY_API UMvGamePhaseAbility : public UMvGameplayAbility
{
    GENERATED_BODY()

public:
    UMvGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Monument Valley|Game Phase")
