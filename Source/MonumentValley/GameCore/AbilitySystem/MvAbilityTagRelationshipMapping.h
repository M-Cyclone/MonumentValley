...
#include "MvAbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FMvAbilityTagRelationship
{
    GENERATED_BODY()
 ...
 */
UCLASS()
class MONUMENTVALLEY_API UMvAbilityTagRelationshipMapping : public UDataAsset
{
    GENERATED_BODY()
...
private:
    ...
    TArray<FMvAbilityTagRelationship> AbilityTagRelationships;
};
